...
<?php
	...
	////////////////////////Projects
	$userID = $_SESSION['UID'];
	$query = mysql_query("SELECT P.ProjectID, P.ProjectName, P.Status, P.StartDate, P.ExpectedEndDate FROM project P, assigned A, users U, requirements R WHERE A.UID = $userID and A.UID = U.UID and A.PID = P.ProjectID and R.PID = P.ProjectID");
