...
<html>
    <head>
        <title>Add Project Requirement</title>
  ...
  <body bgcolor="#DCDCDC">
    ...
    <H1 ALIGN="CENTER">Step 1: Add Requirement</H1>
    <HR WIDTH="36%" SIZE="5" NOSHADE="NOSHADE">
        <form tag="Create Logon" action="addreqsdb.php" method="post">
            <div align="center">
                <?php if(isset($_GET['msg']))
                    echo "<font color='red'><br>" . $_GET['msg'] . "</font>";
                ?>
                Requirement Name*: <input type="text" name="projname" />
                </br></br>
                <table>
                    <tr>
                        <td>
                Requirement Description*: </td><td>&nbsp;<textarea rows="4" cols="50"></textarea></td></tr></table>
                </br>
